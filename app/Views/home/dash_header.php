...
<head>
  ...
  <title>Monjin eLMS | <?= ($uri->getSegment(1) == 'home' ? 'Home' : null)?> <?= ($uri->getSegment(1) == 'user' ? 'Users' : null)?> <?= ($uri->getSegment(1) == 'assignment' ? 'Assignments' : null)?> <?= ($uri->getSegment(1) == 'programs' ? 'Programs' : null)?></title>
